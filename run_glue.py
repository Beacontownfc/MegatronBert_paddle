...
from modeling_MegatronBERT import MegatronBertForSequenceClassification
...
MODEL_CLASSES = {
    "megatronbert": (MegatronBertForSequenceClassification, BertTokenizer),
}
...
def do_train(args):
    ...
    model = model_class.from_pretrained(
        args.model_dir, num_labels=num_classes)
    if paddle.distributed.get_world_size() > 1:
