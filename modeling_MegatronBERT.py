    ...
    def init_weights(self, layer):
        ...
        if isinstance(layer, (nn.Linear, nn.Embedding)):
            ...
            layer._epsilon = self.layer_norm_eps if hasattr(
                self,
                "layer_norm_eps") else self.megatronbert.config["layer_norm_eps"]
...
class MegatronBertAttention(nn.Layer):
    def __init__(self,
        ...
        self.self = MegatronBertSelfAttention(num_attention_heads=num_attention_heads,
                                              attention_probs_dropout_prob=attention_probs_dropout_prob,
                                              max_position_embeddings=max_position_embeddings,
                                              is_decoder=is_decoder,
                                              position_embedding_type=position_embedding_type)
        self.output = MegatronBertSelfOutput(hidden_size=hidden_size,
...
class MegatronBertLayer(nn.Layer):
    def __init__(self,
        ...
        super().__init__()
        self.seq_len_dim = 1
        self.attention = MegatronBertAttention(hidden_size=hidden_size,
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = MegatronBertAttention(hidden_size=hidden_size,
                                                        layer_norm_eps=layer_norm_eps,
                                                        num_attention_heads=num_attention_heads,
                                                        hidden_dropout_prob=hidden_dropout_prob,
                                                        attention_probs_dropout_prob=attention_probs_dropout_prob,
                                                        ...
                                                        position_embedding_type=position_embedding_type)
        self.ln = nn.LayerNorm(hidden_size, epsilon=layer_norm_eps)
        self.intermediate = MegatronBertIntermediate(hidden_size=hidden_size,
                                                     intermediate_size=intermediate_size)
        self.output = MegatronBertOutput(intermediate_size,
                                         hidden_dropout_prob=hidden_dropout_prob,
...
class MegatronBertEncoder(nn.Layer):
    def __init__(self,
                 ...
                 num_hidden_layers=24):
        super().__init__()
        self.layer = nn.LayerList([MegatronBertLayer(hidden_size=hidden_size,
                                                     layer_norm_eps=layer_norm_eps,
                                                     num_attention_heads=num_attention_heads,
                                                     hidden_dropout_prob=hidden_dropout_prob,
                                                     attention_probs_dropout_prob=attention_probs_dropout_prob,
...
class MegatronBertModel(MegatronBertPretrainedModel):
    ...
    def __init__(self,
        ...
        self.embeddings = MegatronBertEmbeddings(vocab_size=vocab_size,
                                                 hidden_size=hidden_size,
                                                 ...
                                                 hidden_dropout_prob=hidden_dropout_prob,
                                                 position_embedding_type=position_embedding_type)
        self.encoder = MegatronBertEncoder(hidden_size=hidden_size,
                                           layer_norm_eps=layer_norm_eps,
                                           num_attention_heads=num_attention_heads,
                                           hidden_dropout_prob=hidden_dropout_prob,
                                           attention_probs_dropout_prob=attention_probs_dropout_prob,
        ...
        self.pooler = MegatronBertPooler(hidden_size=hidden_size) if add_pooling_layer else None
